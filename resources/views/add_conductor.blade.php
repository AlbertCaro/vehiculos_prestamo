    ...
    <div class="form_wh formCenter">
        <form id="busqueda_form" class="form-horizontal" name="form_busqueda" action="{{ route('conductor.store') }}" method="post" entype="application/x-www-form-urlencoded">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="nombre_cont" placeholder="Parentesco" required/>
            </div><br>
            <div class="input-group">
                <span class="input-group-addon">Domicilio</span>
                <input type="text" class="form-control" name="nombre_cont" placeholder="Domicilio completo" required/>
            </div><br>
            <div class="input-group">
                <span class="input-group-addon">Teléfono</span>
                <input type="number" class="form-control" name="nombre_cont" placeholder="Teléfono" required/>
            </div><br>

    ...
    <div class="form_wh formCenter">
        <form id="busqueda_form" class="form-horizontal" name="form_busqueda" action="{{ route('conductor.store') }}" method="post" entype="application/x-www-form-urlencoded">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="nombre_cont" placeholder="Nombre del contacto" @isset($driver->contact) value="{{$driver->contact->nombre}}" @endisset required/>
            </div><br>
            <div class="input-group">
                <span class="input-group-addon">Apellido paterno</span>
